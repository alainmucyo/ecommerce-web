        ...
        <div class="row">
            ...
            <div class="col-md-3" v-for="image in productImages" :key="image.id">
                <div class="card">
                    <div class="card-body">
                        <div class="card-img">
                            <img :src="image.image" @click="showImage(image)"  class="product-image" style="width: 100%;height: 180px">
                        </div>
                    </div>
                </div>
            </div>
        ...
        methods: {
            ...
            deleteImage(image) {
                this.$swal({
                    ...
                    if (result.value) {
                        this.$Progress.start();
                        axios.delete("/product/image/" + image.id)
                            .then(resp => {
                                this.$Progress.finish();
                                const index = this.productImages.findIndex(s => s.id === image.id);
