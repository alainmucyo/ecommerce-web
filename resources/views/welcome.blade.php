                     ...
                     @foreach($products as $product)
                         <div>
                             <div class="home text-left p-right">
                                 <img src="{{ $product->images->first()?$product->images->first()->image:'' }}"
                                      class="bg-img " alt="">
                                 <div class="container">
                                     <div class="row">
                                         <div class="col">
                                             <div class="slider-contain">
                                                 <div
                                                     style="background:rgba(255,255,255,0.5) ; padding: 15px; border-radius: 10px">
                                                     <h4>{{ $product->title }}</h4>
                                                     <h1>{{ number_format($product->price) }} Rwf</h1>
                                                     <a href="/item/{{ $product->slug }}" class="btn btn-solid">shop
                                                         now</a>
                                                 </div>
                                             </div>
                                         </div>
        ...
        @foreach($products as $product)
            <div>
                <div class="home text-center p-center">
                    <img src="{{ $product->images->first()?$product->images->first()->image:'' }}" class="bg-img " alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h5>{{ $product->title }}</h5>
                                        <h1>{{ number_format($product->price) }} Rwf</h1>
                                        <a href="/item/{{ $product->slug }}" class="btn btn-solid">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="media">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             ...
                             viewBox="0 0 334.877 334.877" style="enable-background:new 0 0 334.877 334.877;"
                             xml:space="preserve">
<g>
                    ...
                    <div>
                        <a href="#">
                            <div class="category-wrap">
                                <div>
                                    <img src="/commerce/assets/images/category/layout-3/fashion.png" alt="">
                                    <h5>{{ $category->name }}</h5>
                                </div>
                            </div>
                        </a>
    ...
    <!-- tab section start -->
    <h2></h2>
    <section class="section-b-space tab-layout3">
        <div class="theme-tab">

            <div class="tab-content-cls ratio_square">
                <div id="tab-11" class="tab-content active default">
                    <div class="container">
                        <div class="tab-head">
                            <h2 class="title">Our latest items</h2>
                        </div>
                        <div class="row">
                            @foreach($products as $product)
                                <div class="col-lg-3 col-6 pr-0">
                                    <div class="product-box full-box">
                                        <div class="img-block">
                                            <a href="/item/{{ $product->slug }}">
                                                <img
                                                    ...
                                                    style="width:100% "
                                                    class=" img-fluid bg-img" alt="{{ $product->title }}"></a>
                                            <div class="cart-details">
                                                <button tabindex="0" class="addcart-box" title="Quick shop"><i
                                                        class="ti-shopping-cart"></i></button>

                                                <a href="/item/{{ $product->slug }}" discount="{{ $product->discount }}"
                                        ...
                                        <div class="product-info">
                                            <a href="#"><h6>{{ $product->title }}</h6></a>
                                            @if($product->discount)
                                                <del class="text-warning">{{ number_format($product->price) }} Rwf</del>
                                                <h5>{{ number_format($product->discount->price) }} Rwf</h5>
                                            @else
